...
export function BudgetProgress({ initialBudget, currentExpenses, userCurrency = "INR" }) {
            ...
            {isEditing ? (
              <div className="flex items-center gap-2">
                <Input
                  ...
                  className="w-40 h-10 rounded-xl border-slate-300 focus:border-blue-500 focus:ring-blue-500"
              ...
              <>
                <CardDescription className="text-slate-600 font-medium">
                  {initialBudget
                    ? `${formatCurrency(currentExpenses, userCurrency)} of ${formatCurrency(initialBudget.amount, userCurrency)} spent`
                    : "No budget set"}
                </CardDescription>
                <Button
                  variant="ghost"
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium text-slate-600">
                  {percentUsed >= 90 ? "Over Budget" : percentUsed >= 75 ? "Near Limit" : "On Track"}
                </span>
              </div>
